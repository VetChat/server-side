from .animal_schema import AnimalRead, AnimalCreate
...
__all__ = ["AnimalRead", "AnimalCreate", "UrgentCaseResponse", "UrgentCaseRead", "UrgencyRead", "UrgencyResponse",
           "UrgencyMostRequest", "TicketCreate", "TicketAnswer", "TicketId", "TicketResponse", "SymptomRead",
           "QuestionSetRequest", "QuestionResponse", "AnswerRead", "AnswerRecordCreate", "AnswerRecordResponse",
           "TicketSummaryResponse", "SymptomSummary", "AnswerSummary", "TicketQuestionRead", "TicketAnswerRead"]
