...
VALUES (1, 1, 'Pet ID', 1, '1234', TRUE),
       (2, 1, 'Sex', 2, 'Male', FALSE),
       (3, 1, 'Neutered or not neutered', 3, 'Sterile', FALSE),
       (4, 1, 'Breed', 4, 'Golden Retriever', FALSE),
       (5, 1, 'Birthdate', 5, '2022-02-01', FALSE),
       (6, 2, 'Pet ID', 1, '1454', FALSE),
       (7, 2, 'Sex', 2, 'Male', FALSE),
       (8, 2, 'Neutered or not neutered', 3, 'Non-Sterile', FALSE),
       (9, 2, 'Breed', 4, 'Bulldog', FALSE),
       (10, 2, 'Birthdate', 5, '2021-10-01', FALSE),
       (11, 3, 'Pet ID', 1, '1111', FALSE),
       (12, 3, 'Sex', 2, 'Female', FALSE),
       (13, 3, 'Neutered or not neutered', 3, 'Sterile', FALSE),
       (14, 3, 'Breed', 4, 'Golden Retriever', FALSE),
       (15, 3, 'Birthdate', 5, '2024-04-04', FALSE)