...
(
    ...
    pattern            ENUM ('text', 'choice', 'birthDate', 'breed'),
...
VALUES (1, 'รหัสประจำสัตว์เลี้ยง', 'text', 1, FALSE, TRUE),
       (2, 'เพศ', 'choice', 2, TRUE, TRUE),
       (3, 'ทำหมัน หรือไม่ทำหมัน', 'choice', 3, TRUE, TRUE),
       (4, 'พันธุ์', 'breed', 4, TRUE, TRUE),
       (5, 'วันเกิด', 'birthDate', 5, TRUE, TRUE);
